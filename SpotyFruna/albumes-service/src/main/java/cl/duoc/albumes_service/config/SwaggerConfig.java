package cl.duoc.albumes_service.config;
...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("API Albumes-Service")
                        .version("1.0.0")
                        .description("""
						API ENCARGADA DE GESTIONAR ÁLBUMES/TIPOS DE ÁLBUM.
						
						Funcionalidades principales:
						- CRUD (findAll, findById, save, update y delete).
						- Busquedas personalizadas como: findAllBy [Artist, TipoAlbum] y findAllBetween [Dates].
