...
public class SuscripcionController {
    ...
    public ResponseEntity<SuscripcionDTO> findById(
        ...
        SuscripcionDTO suscripcion = suscripcionService.findById(id);
    ...
    public ResponseEntity<Suscripcion> update(
        ...
        Suscripcion suscripcionInstanciada = suscripcionService.update(id, suscripcion);
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(
                    responseCode = "404",
                    description = "No se encontró ninguna suscripción en el sistema relacionada a la ID ingresada",
                    content = @Content(
                            mediaType = "application/json",
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(
