...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("API Usuarios-Service")
                        .version("1.0.0")
                        .description("""
						API ENCARGADA DE GESTIONAR USUARIOS/TIPOS DE USUARIO.
						
						Funcionalidades principales:
						- CRUD (findAll, findById, save, update y delete).
						- Busquedas personalizadas como: findAllBy [Nickname, TipoUsuario] y findAllBetween [Dates].
